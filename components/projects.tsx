    ...
    <section className=" flex flex-col gap-10 py-10 " id="projects">
      ...
      {projectList.length > previewItems && (
        <button
          ...
          className={`mt-4 self-center ${isExpanded ? ' dark:text-black-100 text-white dark:bg-white bg-black-100' : 'dark:border-white border-black-100 dark:text-white text-black-100'} text-sm mobile:text-base tablet:text-xl lowercase font-bold py-2 px-4 rounded-lg border-2 hover:opacity-80 hover:scale-105 duration-200`}
        >
