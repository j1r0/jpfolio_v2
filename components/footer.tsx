...
const footer = () => {
  return (
    ...
    <p className="relative text-xl tablet:text-2xl font-thin tracking-wide text-center min-w-[20rem] max-w-[50rem] mx-20">i am currently interested in graduate software engineering internships for summer 2025. if you would like to have a quick chat regarding opportunities or anything at all, please feel free to reach out!</p>
