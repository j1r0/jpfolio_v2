...
export const Navbar = ({
  ...
  return (
    ...
    >
    <motion.nav
      className={`flex flex-row gap-1 tablet:gap-10 items-center ${
      scrolled
        ? "justify-around tablet:justify-between"
        : "justify-around tablet:justify-end"
      } tablet:right-0 relative tablet:mx-9 mx-4 lowercase tablet:w-screen py-4`}
    ...
    >
      {scrolled ? (
      <motion.div
        className={`hidden tablet:flex relative text-center text-xl tablet_lg:text-left tablet:text-2xl desktop:text-4xl uppercase font-light tracking-wider cursor-pointer`}
