...
const footer = () => {
  return (
    ...
    <p className="relative text-xl tablet:text-2xl font-thin tracking-wide text-center min-w-[20rem] max-w-[50rem] mx-20 normal-case">Want to collaborate or discuss a project? I&apos;d love to hear from you!</p>
