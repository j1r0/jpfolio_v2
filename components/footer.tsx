...
const footer = () => {
  return (
    ...
    <p className="relative text-xl tablet:text-2xl font-thin tracking-wide text-center min-w-[20rem] max-w-[50rem] mx-20 normal-case">I am currently interested in graduate software engineering internships for Summer 2025. If you would like to have a quick chat regarding opportunities or anything at all, please feel free to reach out!</p>
    <a className='relative' href="mailto:pamplonajimp@gmail.com"><button className="dark:border-white border-black-100 dark:text-white text-black-100 text-sm mobile:text-base tablet:text-xl lowercase font-bold tracking-wider py-2 px-4 rounded-lg border-2 hover:opacity-80 hover:scale-105 duration-200">say hello</button></a>
    </div>
    </div>
